...
const allCaseStudies = [
    ...
    sections: [
      {
        ...
        journey: [
          { icon: 'connect', title: 'Connect', body: 'Link exchanges & wallets.' },
          { icon: 'consolidate', title: 'Consolidate', body: 'One unified portfolio.' },
          { icon: 'understand', title: 'Understand', body: 'Clear holdings & insights.' },
          { icon: 'manage', title: 'Manage', body: 'Categorize transactions.' },
          { icon: 'report', title: 'Report', body: 'Generate tax-ready reports.' },
        ],
        painCardsLabel: 'Where users struggled most',
        painCards: [
          { title: 'Portfolio visibility', body: 'No reliable view of total value.' },
          { title: 'Scattered holdings', body: 'Assets spread across wallets & exchanges.' },
          { title: 'Transaction clarity', body: 'Hard to categorize swaps & transfers.' },
          { title: 'Reporting confidence', body: 'Incomplete data, uncertain reports.' },
        ],
      },
      {
  ...
  },
  {
    ...
    title: 'Turning complex crypto transactions into a powerful accounting workflow',
